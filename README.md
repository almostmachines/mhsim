...
- **Priors**: independent normals centered at the **Prior Belief** settings (std devs fixed at 10 for slope, 20 for intercept, 10 for sigma), with sigma constrained to `>= 0.01`
